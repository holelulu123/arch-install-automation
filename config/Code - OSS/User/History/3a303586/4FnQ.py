import torch
from model.model import SignalCNN2D_STFT_Forward
import numpy as np
import json 
...
class Live_Inference:
    def __init__(self):
        ...
        self.DEVICE_MAPPING = "model/device_mapping.json"
        
        self.IDENTIFICATION_CHECKPOINT_PATH = "model/identification_best_model.pth"
        self.CLASSIFICATION_CHECKPOINT_PATH = "model/classification_best_model.pth"
    ...
    def get_windows(self, signal_array):
        '''
        ...
        signal_array: np.array
            Represent the signal complex64 array 
        Returns:
        -----------
        windows: list
        ...
        windows = self.split_recording(signal_array)
    ...
    def main(self, signal_array):
        ...
        '''
        windows = self.get_windows(signal_array)
