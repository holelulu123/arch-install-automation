...
parser.add_argument("--band_0_9", type=bool, help="Enable recording of 900 MHz band", required=False, default=False)
parser.add_argument("--band_2_4", type=bool, help="Enable recording of 2.4 MHz band", required=False, default=False)
parser.add_argument("--band_5_8", type=bool, help="Enable recording of 5.8 MHz band", required=False, default=False)
