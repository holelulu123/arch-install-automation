...
variables = {
    "receiver_1_lon": get_env_var("receiver_1_lon", cast_type=list),
    "receiver_1_lat": get_env_var("receiver_1_lon", cast_type=list),
    "receiver_2_lon": get_env_var("receiver_1_lon", cast_type=list),
    "receiver_2_lat": get_env_var("receiver_1_lon", cast_type=list),
    "receiver_3_lon": get_env_var("receiver_1_lon", cast_type=list),
    "receiver_3_lat": get_env_var("receiver_1_lon", cast_type=list),
