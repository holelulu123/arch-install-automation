...
variables = {
    "receiver_coordination_1" : [float(receiver_1_lat), float(receiver_1_lon)],  
    "receiver_coordination_2" : [float(receiver_2_lat), float(receiver_2_lon)],  
    "receiver_coordination_3" : [float(receiver_3_lat), float(receiver_3_lon)], 
