...
# Model Parameters
batch_size
config_list = os.getenv("batch_size"), configs_list.append(os.getenv("batch_size"))
windows_per_batch
config_list = os.getenv("windows_per_batch"), configs_list.append(os.getenv("windwos_per_batch"))
device_mapping_path
config_list = os.getenv("device_mapping_path"), configs_list.append(os.getenv("device_mapping_path"))
identification_checkpoint_path
config_list = os.getenv("identification_checkpoint_path"), configs_list.append(os.getenv("identification_checkpoint_path"))
classification_checkpoint_path
config_list = os.getenv("src/model/classification_best_model.pth"), configs_list.append(os.getenv("classification_checkpoint_path"))
