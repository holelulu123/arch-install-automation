...
variables = {
    "receiver_coordination_1": get_env_var("receiver_coordination_1", cast_type=list),
    "receiver_coordination_2": get_env_var("receiver_coordination_2", cast_type=list),
    "receiver_coordination_3": get_env_var("receiver_coordination_3", cast_type=list),
