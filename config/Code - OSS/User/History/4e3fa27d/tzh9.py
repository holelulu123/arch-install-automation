...
variables_listreceiver_coordination_1, configs_list = os.getenv("receiver_coordination_1"), configs_list.append(os.getenv("receiver_coordination_1"))
receiver_coordination_2, config_list = os.getenv("receiver_coordination_2"), configs_list.append(os.getenv("receiver_coordination_2"))
receiver_coordination_3, config_list = os.getenv("receiver_coordination_3"), configs_list.append(os.getenv("receiver_coordination_3"))
