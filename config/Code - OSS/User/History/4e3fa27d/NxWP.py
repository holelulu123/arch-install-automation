...
variables = {
    ...
    "receiver_1_lat": get_env_var("receiver_1_lon", cast_type=float),
    "receiver_2_lon": get_env_var("receiver_1_lon", cast_type=float),
    "receiver_2_lat": get_env_var("receiver_1_lon", cast_type=float),
    "receiver_3_lon": get_env_var("receiver_1_lon", cast_type=float),
    "receiver_3_lat": get_env_var("receiver_1_lon", cast_type=float),
