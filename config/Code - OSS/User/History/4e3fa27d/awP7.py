...
receiver_1_lat = get_env_var("receiver_1_lat", cast_type=float)[0],
receiver_1_lon = get_env_var("receiver_1_lon", cast_type=float)[0],
receiver_2_lat = get_env_var("receiver_2_lat", cast_type=float)[0],
receiver_2_lon = get_env_var("receiver_2_lon", cast_type=float)[0],
receiver_3_lat = get_env_var("receiver_3_lat", cast_type=float)[0],
receiver_3_lon = get_env_var("receiver_3_lon", cast_type=float)[0],

variables = {
    "receiver_coordination_1" : [receiver_1_lat, receiver_1_lon],  
    "receiver_coordination_2" : [receiver_2_lat, receiver_2_lon],  
    "receiver_coordination_3" : [receiver_3_lat, receiver_3_lon], 
