...
variables = {
    "receiver_coordination_1" : list([receiver_1_lat, receiver_1_lon])  
    "receiver_coordination_2" : list([receiver_2_lat, receiver_2_lon])  
    "receiver_coordination_3" : list([receiver_3_lat, receiver_3_lon])  
