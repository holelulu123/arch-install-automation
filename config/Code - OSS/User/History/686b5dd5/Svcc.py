...
def run_algo(node1_dir: str, node2_dir: str, node3_dir: str, frequency: float):
    ...
    deltas_1_2, deltas_1_3 = cross_corr_3_receivers(
        ...
        fs=global_variables.variables["fs"],
        max_distance=global_variables.variables["max_distance"],
    )
    ...
    data = object_coordinates(
        deltas_1_2,
        deltas_1_3,
        global_variables.variables["receiver_coordination_1"],
        global_variables.variables["receiver_coordination_2"],
        global_variables.variables["receiver_coordination_3"],
        frequency,
        model_results
    )
