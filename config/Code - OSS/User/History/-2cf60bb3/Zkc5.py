...
nf_high_band = nf_calculator(np.array([24.5, 20]), np.array([1.5, 13]))
print(f'NF for Low band is: {nf_low_band[0][0]} dB')
print(f'NF for High band is: {nf_high_band[0][0]} dB')
sen_low_band = receiver_sensitivity(30.72e6, 0, nf_low_band[0][0])
sen_high_band = receiver_sensitivity(30.72e6, 0, nf_high_band[0][0])
