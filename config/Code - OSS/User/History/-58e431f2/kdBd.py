...
class Live_Inference:
    def __init__(self):
        ...
        self.WINDOWS_PER_BATCH = global_variables.windows_per_batch
        self.DEVICE_MAPPING = global_variables.device_mapping_path
        
        self.IDENTIFICATION_CHECKPOINT_PATH = global_variables.identification_checkpoint_path
        self.CLASSIFICATION_CHECKPOINT_PATH = global_variables.classification_checkpoint_path

        self.NUM_WINDOWS = global_variables.num_windows
