...
class Live_Inference:
    def __init__(self):
        ...
        self.DEVICE_MAPPING = 'src/model/device_mapping.json'
        
        self.IDENTIFICATION_CHECKPOINT_PATH = "src/model/identification_best_model.pth"
        self.CLASSIFICATION_CHECKPOINT_PATH = "src/model/classification_best_model.pth"
