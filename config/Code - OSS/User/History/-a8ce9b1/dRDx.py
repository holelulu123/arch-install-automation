...
directory, fs, samples_record_time, number_of_replicas,directory_of_saving
    ...
    parser.add_argument("--time", type=float, help="Internal RF gain of the SDR", required=False, default=30)
    parser.add_argument("--replicas", type=int, help="Replicas per one RF recording", required=False, default=30)
