...
int main(){
    ...
    int rows, cols;
    bool apple_good, snake_good, snake_eat_himself;
    
    int direction = 1; // direction of snake initialization
    ...
    [random_num_col, random_num_row] = random_apple_index(rows, cols);
    ...
    while(true) {
        ...
        snake_good = check_snake_limit(snake, rows, cols);
        if (!snake_good){
