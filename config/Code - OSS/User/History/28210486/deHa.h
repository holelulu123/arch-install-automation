...
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)1)
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)2)
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)3)
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)4)
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)5)
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)6)
#define RegIrqFlags_RxDone_Pos               ((__uint8_t)7)
