...
If you finished this steps above, you're almost done. This section explains how to use RF recorder, Very comfortable application for Visualing RF signals in the field and recording the RF baseband data into your Drive.
