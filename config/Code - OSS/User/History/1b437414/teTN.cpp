...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("secs", po::value<double>(&seconds_in_future)->default_value(5), "number of seconds in the future to receive")
    ...
    while (num_acc_samps < total_num_samps) {
        ...
        std::cout << "First Address is: " << &buff[0] << "Real: " << buff[0].real << "| Imag: " << buff[0].imag << std::endl;
        // std::cout << "Recieve number: " << count << std::endl; 
        count +=1;
