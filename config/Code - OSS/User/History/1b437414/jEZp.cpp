...
int main(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("freq", po::value<double>(&freq)->default_value(2.44e9), "RF center frequency in Hz")
        ("secs", po::value<double>(&seconds_in_future)->default_value(1), "number of seconds in the future to receive")
    ...
    std::cout << "size of one value is: " << sizeof(std::complex<float>) << std::endl;
    std::cout << "Number of samples is: " << rx_stream-> get_max_num_samps() << std::endl;
    std::cout << "size of data is: " << sizeof(std::complex<float>) * rx_stream -> get_max_num_samps() << std::endl; 
